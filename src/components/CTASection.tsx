      ...
      <section className="relative overflow-hidden py-12 pl-[max(1rem,env(safe-area-inset-left))] pr-[max(1rem,env(safe-area-inset-right))] sm:px-6 sm:py-16 lg:px-8">
        ...
        <div className="relative mx-auto max-w-6xl">
          ...
          >
            ...
            <div className="relative min-w-0 max-w-2xl text-left">
              {badge ? (
              ...
              <div className="mt-8 flex min-w-0 flex-col gap-3 sm:flex-row sm:items-center sm:gap-4">
                <motion.span whileHover={{ scale: 1.03 }} whileTap={{ scale: 0.98 }} className="w-full min-w-0 sm:w-auto">
                  <Link
                    href={primaryHref}
                    className="inline-flex w-full min-w-0 items-center justify-center gap-2 rounded-full bg-[#c4a574] px-5 py-3 text-sm font-semibold text-[#1a1814] shadow-md transition hover:bg-[#b89660] sm:w-auto sm:px-8 sm:py-3.5"
                  >
                    {primaryLabel}
                ...
                <motion.span whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.98 }} className="w-full min-w-0 sm:w-auto">
                  <Link
                    href={secondaryHref}
                    className="inline-flex w-full min-w-0 items-center justify-center rounded-full border border-[#c4b8a8] bg-[#f0ebe3] px-5 py-3 text-sm font-semibold text-[#1a1814] transition hover:bg-[#e5dfd4] sm:w-auto sm:px-8 sm:py-3.5"
                  >
                    {secondaryLabel}
                  </Link>
                </motion.span>
  ...
  return (
    <section className="relative overflow-hidden py-16 sm:py-20">
      ...
      >
        ...
        <div className="mt-8 flex w-full min-w-0 max-w-lg flex-col items-stretch justify-center gap-3 px-2 sm:mx-auto sm:max-w-none sm:flex-row sm:items-center sm:gap-4 sm:px-0">
          <motion.span whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.97 }} className="w-full sm:w-auto">
            <Link
              href={primaryHref}
              className="inline-flex w-full min-w-0 items-center justify-center rounded-xl bg-gradient-to-r from-brand-gold to-brand-gold-light px-6 py-3.5 text-sm font-semibold text-brand-navy shadow-lg sm:min-w-[11rem] sm:text-base"
            >
              {primaryLabel}
            </Link>
          </motion.span>
          <motion.span whileHover={{ scale: 1.03 }} whileTap={{ scale: 0.98 }} className="w-full sm:w-auto">
            <Link
              href={secondaryHref}
              className="inline-flex w-full min-w-0 items-center justify-center rounded-xl border border-white/40 px-6 py-3.5 text-sm font-semibold text-white transition hover:bg-white/10 sm:min-w-[11rem] sm:text-base"
            >
              {secondaryLabel}
            </Link>
          </motion.span>
